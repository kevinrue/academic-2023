...
I particularly enjoy using and contributing R packages as part of the [Bioconductor project](https://www.bioconductor.org/).
...
[Sims Group](https://www.imm.ox.ac.uk/research/units-and-centres/mrc-wimm-centre-for-computational-biology/groups/sims-group-computational-genomics), [MRC WIMM Centre for Computational Biology](https://www.imm.ox.ac.uk/research/units-and-centres/mrc-wimm-centre-for-computational-biology),  [University of Oxford](http://www.ox.ac.uk/)

Oxford, UK

2020-present

- Development and delivery of training materials to cohorts of trainees as part of the [Oxford Biomedical Data Science Training Programme](https://www.imm.ox.ac.uk/research/units-and-centres/mrc-wimm-centre-for-computational-biology/training/oxford-biomedical-data-science-training-programme).
- Development of novel bioinformatics tools and pipelines following software engineering best practices.
- Contribution to scientific reports and publications.
...
### Co-supervision for MSc summer intership

[Lisa Guzzi](https://www.linkedin.com/in/lisa-guzzi-3687731b7), [The Carpentries](https://carpentries.org/)

Google Meet (online)

Jun. 2021 - Aug. 2021

Development of scripts and pipelines for the study of transcriptional regulation
in the _Drosophila melanogaster_ midbrain using single-cell genomics.

### Bioconductor teaching committee

[Bioconductor](https://bioconductor.org/), [The Carpentries](https://carpentries.org/)

Google Meet (online)

Aug. 2020 - present

Development of online lessons in [The Carpentries lesson incubator](https://github.com/carpentries-incubator/).
Lead developer of the lesson [The Bioconductor project](https://carpentries-incubator.github.io/bioc-project/).
...
Full-time trainer for a course of four to seven weeks run three times a year.
Lessons cover Unix, Python and R for data science and biomedical research.

### Intuitive interactive data exploration with iSEE
...
Co-organizer of a [2h30 workshop](https://github.com/iSEE/iSEEWorkshop2020) at the [SIB Days 2020](https://www.sib.swiss/events/sibdays2020/).

### R Code Clinic

[Big Data Institute](https://www.sib.swiss/), [University of Oxford](http://www.ox.ac.uk/)
...
### Bioconductor Multilingual Working Group

Working group of the [Bioconductor Community Advisory Board](https://bioconductor.org/about/community-advisory-board/).

Zoom (online)

2021 - present

Co-organiser and reviewer of applications from prospective mentors and mentees.
Lead developer of the [Multilingual Bioconductor Code of Conduct](https://bioconductor.github.io/bioc_coc_multilingual/).

### Bioconductor New Developer Program

[Program website](http://bioconductor.org/developers/new-developer-program/).
...
Co-organiser and reviewer of applications from prospective mentors and mentees.
Lead developer of the [Bioconductor Guidelines for Mentors and Mentees](https://bioconductor.github.io/bioc_mentorship_docs/).

### Bioconductor Package Review Working Group
...
Recruitment of volunteer package reviewers in the Bioconductor community.
Lead developer of [Bioconductor Packages: Development, Maintenance, and Peer Review](http://contributions.bioconductor.org/).

### Bioconductor conference 2021

[Conference website](http://bioc2021.bioconductor.org/).

Airmeet (online)

2021

Co-organiser and point of contact for the coordination and testing of live workshops.

### European Bioconductor conference 2020

[Conference website](http://eurobioc2020.bioconductor.org/).

Airmeet (online)

2020

Co-organiser, session chair, and support for the coordination and testing of live workshops.
...
<http://www.bioconductor.org/about/community-advisory-board/>
...
* [Talk](https://kevinrue.github.io/velociraptor_talk_bioc2021/): <img src="bioconductor.favicon.ico" alt="Bioconductor favicon" width="10px"> [`velociraptor`](https://bioconductor.org/packages/velociraptor/), a Bioconductor toolkit for single-cell RNA velocity.
